# Contributing to Next.js Forms

Thank you for considering contributing to the **Next.js Forms** project! Your contributions are highly appreciated.
...
If you find a bug, please open an issue on the [GitHub Issues](https://github.com/ninsau/nextjs-forms/issues) page with the following information:
...
```bash
git clone https://github.com/ninsau/nextjs-forms.git
cd nextjs-forms
npm install
```
